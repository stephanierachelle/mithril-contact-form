...
var entryFormHandler = function entryFormHandler(entryForm) {
...
var EntryForm = {
  ...
  view: function view(vnode) {
    return m(
      ...
      m("input", { id: "first-name", type: "text", name: "name" }),
      m(
        "label",
        { "for": "last-name" },
        "Last Name"
      ),
      m("input", { id: "last-name", type: "text", name: "name" }),
      m(
        "label",
        { "for": "email" },
        "Your email"
      ),
      m("input", { id: "email", type: "text", name: "email" }),
      m(
        "label",
        { "for": "message" },
        "Your Message"
      ),
      m("input", { id: "input-message", type: "text", name: "input-message" }),
...
var _MainContainer = __webpack_require__(/*! ./MainContainer.jsx */ "./src/components/layout/MainContainer.jsx");
...
var HomeView = function HomeView() {
  return m(_StageBanner2.default, {
    action: function action() {
      return console.log("Logging out!");
    },
    title: "Conferences"
  }), m(_MainContainer2.default, null);
};
...
var _MainContainer = __webpack_require__(/*! ./components/layout/MainContainer.jsx */ "./src/components/layout/MainContainer.jsx");
...
var HomeView = function HomeView(main) {
  return m(_App2.default, null);
};
